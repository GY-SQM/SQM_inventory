// writeApi.js — /outbound/confirm 추가
// 배치: web/src/api/writeApi.js (기존 덮어쓰기)
...
// ★ 신규: PICKED → OUTBOUND 확정
export function confirmOutbound(lotNo, forceAll = false) {
  return postJson('/outbound/confirm', { lot_no: lotNo, force_all: forceAll });
}
