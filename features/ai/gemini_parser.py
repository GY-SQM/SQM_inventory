...
```json
{
    ...
    "product": "제품명 (예: LITHIUM CARBONATE - BATTERY GRADE - MICRONIZED, LITHIUM CARBONATE - BATTERY GRADE - CRYSTAL, LITHIUM HYDROXIDE MONOHYDRATE - BATTERY GRADE)",
    "product_code": "제품 코드 (예: MIC9000.00, CRY9000.00, LHT-B/450 — 문서에 표기된 그대로 추출)",
    "quantity_mt": 100.02,
    "unit_price": 9272.00,
