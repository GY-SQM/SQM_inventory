...
class AiFallbackSettings:
    ...
    compare_free_paid_enabled: bool = True
    provider_order: tuple = DEFAULT_PROVIDER_ORDER
...
def load_ai_fallback_settings():
    ...
    values = {
        ...
        "compare_free_paid_enabled": True,
    ...
    env_map = {
        ...
        "SQM_AI_COMPARE_FREE_PAID": "compare_free_paid_enabled",
    ...
    return AiFallbackSettings(
        ...
        compare_free_paid_enabled=_as_bool(values["compare_free_paid_enabled"], True),
