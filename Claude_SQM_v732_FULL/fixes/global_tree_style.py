...
# ═══════════════════════════════════════════
DARK_COLORS = {
    'bg':        '#0b1120',     # Deep Navy (통일)
    'fg':        '#e2e8f0',     # Bright Slate (통일)
    'odd_bg':    '#0f1a2e',     # Slightly lighter Navy
    'even_bg':   '#0b1120',     # Deep Navy
    'sel_bg':    '#1d4ed8',     # Blue selection (통일)
    'sel_fg':    '#ffffff',
    'head_bg':   '#1e293b',     # Slate header (통일)
    'head_fg':   '#e2e8f0',     # Bright Slate
    'head_hover': '#334155',    # Lighter Slate
}
...
LIGHT_COLORS = {
    ...
    'sel_fg':    '#1e3a5f',     # Dark Blue
    'head_bg':   '#f1f5f9',     # Slate 100
    'head_fg':   '#1e293b',     # Slate 800
    'head_hover': '#e2e8f0',    # Slate 200
}
