...
class AllocationStressTestDialog:
    ...
    def _build_ui(self):
        ...
        tk.Label(
            ...
            bg=C_HEAD, fg="white", font=("맑은 고딕", 12, "bold")
        ...
        self._btn_run = tk.Button(
            btn_f, text="▶  전체 실행", width=14, bg="#1F4E79", fg="white",
        ...
        tk.Label(btn_f, textvariable=self._var_status,
                 fg="#555").pack(side=tk.RIGHT, padx=10)
        ...
        self._tree.heading("gate",   text="Gate")
        self._tree.heading("desc",   text="테스트 내용")
        self._tree.heading("result", text="결과")
        ...
        self._tree.tag_configure("run",  background="#e8f0fe")
