...
from tkinter.constants import BOTH, END, LEFT, RIGHT, X, Y, NSEW, W
...
class PickingTemplateDialog:
    ...
    def _build_ui(self):
        ...
        hdr = tk.Frame(self.popup,
                       bg='#1A5276' if _is_select else '#2C3E50',
                       padx=12, pady=8)
        hdr.pack(fill=X)
        _title = ('🔍 출고 피킹 템플릿 선택'
    ...
    def _build_tab_logistics(self, p):
        ...
        def e_bag(r):
            ...
            self._bag_badge = tk.Label(frm, text='', font=('맑은 고딕',10,'bold'),
                                       fg='white', bg='#27AE60', relief='flat', padx=6, pady=1)
    ...
    def _refresh_bag_badge(self, _=None):
        try:
            ...
            bg = '#27AE60' if v == 500 else '#E67E22'
