...
class TableStyler:
    ...
    # v7.3.3: Soft Minimalism 라이트 팔레트
    COLORS = {
        # 그리드 라인
        'grid_line': '#e2e8f0',
        ...
        'row_even': '#ffffff',
        'row_odd': '#f8fafc',
        'row_even_selected': '#dbeafe',
        'row_odd_selected': '#bfdbfe',
        'row_selected_fg': '#1e3a5f',
    ...
    # v7.3.3: 다크 테마 — GY Navy 통일 팔레트
    COLORS_DARK = {
        'grid_line': '#1e3a5f',
        'grid_line_strong': '#334155',
        'row_even': '#0b1120',
        'row_odd': '#0f1a2e',
        'row_even_selected': '#1d4ed8',
        'row_odd_selected': '#1e40af',
        'row_selected_fg': '#ffffff',
        'header_bg': '#1e293b',   # Slate header (통일)
        'header_fg': '#e2e8f0',
        'border': '#1e3a5f',
        'foreground': '#e2e8f0',
