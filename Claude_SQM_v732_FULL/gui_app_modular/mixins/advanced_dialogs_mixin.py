...
class AdvancedDialogsMixin:
    ...
    def _apply_return_inbound_after_parse(
        ...
        if not skip_confirm:
            ...
            try:
                from engine_modules.constants import RETURN_AUTO_APPROVE_MAX_TONBAGS, STATUS_PICKED, STATUS_RESERVED, STATUS_SOLD
    ...
    def _show_return_export_history(self) -> None:
        ...
        def _entry(parent, width=12, val=''):
            e = tk.Entry(parent, width=width, bg='#1a237e', fg=FG,
                         insertbackground=FG,
                         font=('Malgun Gothic', 9), relief='flat', bd=1)
            e.insert(0, val)
            return e
        ...
        ent_lot = tk.Entry(row0, textvariable=lot_var, width=14,
                           bg='#1a237e', fg=FG, insertbackground=FG,
                           font=('Malgun Gothic', 9), relief='flat', bd=1)
        ...
        tk.Button(
            row0, text='🔍 조회', font=('Malgun Gothic', 9, 'bold'),
            bg='#651fff', fg=FG, activebackground='#7c4dff',
            relief='flat', bd=0, padx=14, pady=3, cursor='hand2',
            command=lambda: _do_query(),
        ).pack(side='left', padx=(0, 6))

        tk.Button(
            row0, text='📊 Excel 저장', font=('Malgun Gothic', 9),
            bg='#2979ff', fg=FG, activebackground='#82b1ff',
            relief='flat', bd=0, padx=14, pady=3, cursor='hand2',
        ...
        tk.Label(dialog, textvariable=summary_var,
                 bg=BG, fg=FG2, font=('Malgun Gothic', 9),
        ...
        style.configure('RetExport.Treeview',
                        ...
                        rowheight=23, font=('Malgun Gothic', 9))
        ...
        tree.tag_configure('bangsong',background='#3e1a00', foreground=ORANGE)
        tree.tag_configure('bangsong_stripe', background='#2e1200', foreground=ORANGE)
        ...
        tk.Button(
            ...
            bg='#5c6bc0', fg=FG, activebackground='#7986cb',
