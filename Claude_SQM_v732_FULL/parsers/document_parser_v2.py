# -*- coding: utf-8 -*-
# ⚠️ [v7.0.0 DEPRECATED] document_parser_v2.py
# 이 파일은 향후 버전에서 제거 예정입니다.
# 현재 참조: onestop_inbound.py, do_update_dialog.py, gui_bootstrap.py
# 대체: parsers/document_parser_modular/ 패키지 사용 권장
# TODO: 위 3개 파일 마이그레이션 후 삭제
#
"""
