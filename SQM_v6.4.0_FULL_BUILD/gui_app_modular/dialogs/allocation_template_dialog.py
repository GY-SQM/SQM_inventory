...
# 색상 상수 (다크 테마 기준)
# ─────────────────────────────────────────
C_BG        = '#1a237e'   # bg_primary
C_BG2       = '#283593'   # bg_secondary
C_FG        = '#ffffff'   # text_primary
C_FG2       = '#b0bec5'   # text_secondary
C_ACCENT    = '#00e5ff'   # border_focus
C_SUCCESS   = '#00e676'   # success
C_WARNING   = '#ffea00'   # warning
C_DANGER    = '#ff1744'   # danger
C_STRIPE    = '#303f9f'   # tree_stripe
C_SELECT    = '#651fff'   # tree_select_bg
C_SAMPLE    = '#ff9100'   # orange — 샘플 행 강조
C_BTN_DL    = '#2979ff'   # 다운로드 버튼
C_BTN_CLOSE = '#5c6bc0'   # 닫기 버튼
    ...
    def _get_data(self, idx: int) -> Tuple[List[str], List[tuple]]:
        ...
        if filepath:
            ...
            if cols and rows:
                ...
                return cols, rows
            logger.warning(f"[AllocationTemplateDialog] 파일 로드 실패, 내장 데이터 사용")
