...
(function () {
  ...
  function ensureModal() {
    ...
    m.innerHTML='<div id="sqm-modal-inner" style="background:var(--bg-card);border-radius:8px;width:min(1280px,92vw);max-width:92vw;min-height:200px;max-height:88vh;position:fixed;top:65px;left:50%;transform:translateX(-50%);overflow:visible;display:flex;flex-direction:column;">'
      +'<div id="sqm-modal-header" style="flex-shrink:0;cursor:move;user-select:none;background:var(--bg-hover,rgba(0,0,0,.06));border-radius:8px 8px 0 0;border-bottom:1px solid var(--panel-border);padding:5px 48px 5px 12px;font-size:11px;color:var(--text-muted);display:flex;align-items:center;gap:6px;min-height:28px;position:relative;">'
  ...
  function _showParseLogPanel() {
    ...
    var p = document.createElement('div');
    p.id = 'sqm-parse-log';
    p.style.cssText = 'position:fixed;top:130px;right:28px;width:340px;background:var(--bg-card);border:1px solid var(--panel-border);border-radius:10px;box-shadow:0 8px 32px rgba(0,0,0,.45);z-index:10001;font-size:12px;display:flex;flex-direction:column';
    p.innerHTML =
