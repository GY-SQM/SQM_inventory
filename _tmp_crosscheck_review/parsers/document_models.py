...
class InvoiceData:
    ...
    invoice_date: date = None        # 2025-09-06
...
class PackingListData:
    ...
    parsed_at: datetime = None
    raw_text: str = ""
    duplicates_removed: int = 0  # v6.2.1: 파싱 시 자동 제거된 중복 행 수
...
class BLData:
    ...
    # 날짜
    shipped_on_board_date: date = None  # 2025-09-06
    ship_date: date = None              # 호환용 alias
    issue_date: date = None             # 2025-09-07
...
class DOData:
    ...
    # 날짜 (중요!)
    arrival_date: date = None        # 2025-10-17 (선박 입항일)
    issue_date: date = None          # 2025-10-20 (D/O 발행일)
    stock_date: date = None          # v2.9.29: DATE IN STOCK (arrival_date와 분리)
...
class ShipmentDocuments:
    ...
    packing_list: PackingListData = None
    bl: BLData = None
    do: DOData = None
    ...
    # 날짜
    invoice_date: date = None        # Invoice에서
    shipped_date: date = None        # B/L에서 (선적일)
    arrival_date: date = None        # D/O에서 (입항일)
