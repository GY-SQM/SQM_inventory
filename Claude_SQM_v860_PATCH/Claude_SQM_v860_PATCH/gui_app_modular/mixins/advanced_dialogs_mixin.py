    ...
    def _build_return_excel_tab(self, nb, dialog) -> None:
        ...
        def _upload_return_excel():
            ...
            try:
                ...
                # v8.2.0 N+1 최적화: inventory pre-fetch
        ...
        try:
            if is_dn:
                ...
                if actual and str(actual).startswith("INCOMPLETE:"):
                    ...
                    warn_msg = (
                        "Sales Order '{}' 의 모든 화물이 출고 완료되지 않았습니다.\n\n"
                        "  출고 완료: {}개 LOT\n"
                        "  배정 전체: {}개 LOT\n\n"
                        "모든 화물 출고 완료 후 Sales Order DN을 생성할 수 있습니다.\n"
                        "(출고 현황은 화물 총괄 탭에서 확인하세요)"
                    ).format(sale_ref, out_cnt, total_cnt)
