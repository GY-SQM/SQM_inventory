...
class InventoryTabMixin:
    ...
    def _setup_inventory_tab(self) -> None:
        ...
        try:
            ...
            _is_dark_hdr = ThemeColors.is_dark_theme(getattr(self, 'current_theme', 'flatly'))
        ...
        # v7.8.0: 시작 시 톤백 상세 패널 접기 (공간 최적화)
        self._inv_split_panel.collapse_detail()
        ...
        # v7.7.2: h_scroll을 tree보다 먼저 pack해야 하단에 표시됨
    ...
    def _on_inv_selection_change(self, event) -> None:
        ...
        if not lot_no:
            return
        # v7.8.0: LOT 선택 시 접힌 패널 자동 펼침
        self._inv_split_panel.expand_detail()
