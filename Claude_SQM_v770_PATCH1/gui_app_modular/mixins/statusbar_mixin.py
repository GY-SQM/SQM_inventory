...
class StatusBarMixin:
    ...
    def _setup_status_bar(self) -> None:
        ...
        try:
            ...
            _p = {'success': '#059669', 'warning': '#D97706', 'danger': '#DC2626',
                  'text_secondary': '#475569', 'text_primary': '#0F172A',
                  'statusbar_icon_ok': '#059669', 'statusbar_icon_warn': '#D97706',
        ...
        self._inv_summary_label = ttk.Label(
            ...
            font=("맑은 고딕", 9, "bold"),
            foreground=_p.get('text_primary', '#0F172A'),
            anchor="w"
        )
