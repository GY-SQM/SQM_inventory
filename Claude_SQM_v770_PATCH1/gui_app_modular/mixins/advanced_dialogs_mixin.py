...
class AdvancedDialogsMixin:
    ...
    def _show_return_export_history(self) -> None:
        ...
        def _entry(parent, width=12, val=''):
            e = tk.Entry(parent, width=width, bg='#0B1220', fg=FG,
                         insertbackground=FG,
        ...
        ent_lot = tk.Entry(row0, textvariable=lot_var, width=14,
                           bg='#0B1220', fg=FG, insertbackground=FG,
                           font=('Malgun Gothic', 9), relief='flat', bd=1)
        ...
        tk.Button(
            ...
            bg='#2563EB', fg=FG, activebackground='#60A5FA',
        ...
        tk.Button(
            ...
            bg='#475569', fg=FG, activebackground='#64748B',
