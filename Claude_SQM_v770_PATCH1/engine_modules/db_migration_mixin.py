    ...
    def _migrate_v675_conflict_indexes(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # v7.7.0-P7: rollback 실패도 로깅
                logger.warning(f"[v6.7.5] rollback 실패 (무시): {_rb_e}")
    ...
    def _migrate_v710_return_history_to_log(self) -> None:
        ...
        try:
            ...
            try:
                ...
                # v7.7.0-P7: rollback 실패도 로깅
                logger.warning(f"[v7.1.0] rollback 실패 (무시): {_rb_e}")
        ...
        for col_name, col_def in cols_to_add:
            try:
                existing = {str(r.get("name","")).lower()
                            for r in (self.db.fetchall("PRAGMA table_info(picking_table)") or [])}
