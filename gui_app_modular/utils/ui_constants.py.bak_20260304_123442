...
class ThemeColors:
    ...
    DARK = {
    # Semantic (Colorful Neon / Cyberpunk Style)
    'success': '#00e676',    # Bright Neon Green
    'warning': '#ffea00',    # Bright Neon Yellow
    'danger':  '#ff1744',    # Bright Neon Red
    'info':    '#00b0ff',    # Bright Neon Blue
    'primary': '#651fff',    # Bright Deep Purple

    # Status (Vivid Colors for Visibility)
    'available': '#00c853',  # Vivid Green (판매가능)
    'reserved':  '#ff9100',  # Vivid Orange (판매배정)
    'picked':    '#d500f9',  # Vivid Magenta (판매화물 결정)
    'shipped':   '#2979ff',  # Vivid Blue (출고/정보)
