...
class AdvancedDialogsMixin:
    ...
    # -----------------------------------------------------------------
    # _bret_* : _build_return_excel_tab 서브 메서드  # v8.7.0 [SRP]
    # -----------------------------------------------------------------

    def _bret_download_template(self, dialog) -> None:  # v8.7.0 [SRP]
    ...
    def _bret_build_preview_tree(self, tab_excel, tk, ttk):  # v8.7.0 [SRP]
    ...
    def _bret_map_columns(self, df):  # v8.7.0 [SRP]
    ...
    def _bret_prefetch_inventory(self, df, col_map):  # v8.7.0 [SRP]
    ...
    def _bret_resolve_product_bl(self, lot_no, bl_no, _inv_cache):  # v8.7.0 [SRP]
    ...
    def _bret_resolve_tonbags(self, lot_no, tonbag_str, return_qty_kg, returnable_statuses):  # v8.7.0 [SRP]
    ...
    def _bret_upload_return_excel(self, dialog, file_var, pv_tree, parsed_returns, summary_var):  # v8.7.0 [SRP]
    ...
    def _bret_populate_preview(self, dialog, df, col_map, header_row,  # v8.7.0 [SRP]
    ...
    def _bret_execute_bulk_return(self, dialog, parsed_returns):  # v8.7.0 [SRP]
