...
class OutboundScheduledTabMixin:
    ...
    def _setup_outbound_scheduled_tab(self) -> None:
        ...
        h_scroll = ttk.Scrollbar(tree_frame, orient='horizontal', command=self.tree_outbound_scheduled.xview)
    ...
    def _setup_ob_allocation_detail_panel(self) -> None:
        ...
        sb = ttk.Scrollbar(detail_container, orient=VERTICAL, command=self._ob_alloc_detail_tree.yview)
