...
from tkinter.constants import BOTH, END, LEFT, RIGHT, X
...
class ReturnStatisticsDialog:
    ...
    def __init__(self, parent, engine, current_theme: str = 'flatly'):
        self.parent = parent
        self.engine = engine
        self.stats = {}
        ...
        self.fg = ThemeColors.get('text_primary', is_dark) if ThemeColors else '#000000'
        ...
        # ═══ 기간 필터 바 ═══
        filter_frame = tk.Frame(popup, bg='#34495E', padx=10, pady=8)
        filter_frame.pack(fill=X)

        tk.Label(filter_frame, text="📅 기간:", font=('맑은 고딕', 10, 'bold'),
                 bg='#34495E', fg='#FFFFFF').pack(side=LEFT, padx=(0, 5))
        ...
        tk.Label(filter_frame, text="~", bg='#34495E', fg='#FFFFFF',
        ...
        # ═══ 헤더 (동적) ═══
        self.header_frame = tk.Frame(popup, bg='#2C3E50', padx=15, pady=8)
        self.header_frame.pack(fill=X)
        self.header_title = tk.Label(self.header_frame, text="📊 반품 사유 통계 리포트",
                                     font=('맑은 고딕', 13, 'bold'), bg='#2C3E50', fg='#FFFFFF')
        self.header_title.pack(anchor='w')
        self.header_summary = tk.Label(self.header_frame, text="",
                                        font=('맑은 고딕', 10), bg='#2C3E50', fg='#FFFFFF')
