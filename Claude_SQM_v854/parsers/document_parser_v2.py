# -*- coding: utf-8 -*-
# ⚠️ [v7.3.4 FULLY_DEPRECATED] document_parser_v2.py
# v7.3.4에서 onestop_inbound.py, do_update_dialog.py 모두 V3로 마이그레이션 완료.
# 이 파일은 하위호환 래퍼로만 유지. 직접 import 금지.
# 대체: parsers/document_parser_modular.DocumentParserV3
# 삭제 예정: v7.5.0 (하위호환 확인 후)
#
"""
