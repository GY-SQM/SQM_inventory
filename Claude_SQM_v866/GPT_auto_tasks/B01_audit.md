...
8. Create a structured audit report containing:
   - system flow understanding
   - symptom / direct cause / structural cause
   - SAFE ZONE / DANGER ZONE
   - recommended P0 / P1 / P2 targets
   - candidate stage-gate test areas for B02/B03/B04
9. Do not apply broad refactors in this batch.
10. Tiny helper scripts for reporting are allowed if they are low-risk and isolated.
