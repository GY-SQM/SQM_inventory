...
def main():
    # Windows/Linux 공통: 시스템 임시 디렉터리 사용
    TEST_DB = os.path.join(tempfile.gettempdir(), "sqm_test_v600.db")
    ...
    print("─" * 40)
    for t in ["picking_table", "sold_table"]:
