...
class InboundHistoryDialog:
    ...
    def _create_dialog(self) -> None:
        ...
        self.entry_start.config(textvariable=self._start_var)
        self.entry_end.config(textvariable=self._end_var)
        try:
            from gui_app_modular.utils.tree_enhancements import attach_date_placeholder
            attach_date_placeholder(self.entry_start, self._start_var)
            attach_date_placeholder(self.entry_end,   self._end_var)
        except Exception as e:
