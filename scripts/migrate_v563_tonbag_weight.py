# -*- coding: utf-8 -*-
"""
SQM v5.6.3 DB 마이그레이션 — 톤백 무게 보정 (P2: scripts/로 이동)
기존 DB: per_bag = total_w / bag_count (샘플 미차감 → 500.1kg)
수정 후: 톤백 = 500kg, 샘플 = 1kg

사용법: python scripts/migrate_v563_tonbag_weight.py
"""
import sqlite3
import os
import shutil
...
# 프로젝트 루트 기준 (scripts/ 상위)
_BASE = Path(__file__).resolve().parent.parent
DB_PATH = str(_BASE / "data" / "db" / "sqm_inventory.db")
