                    ...
                    if doc_type == 'PACKING_LIST':
                        ...
                        if bl_result:
                            ...
                            if _carrier_id and _carrier_id != 'UNKNOWN':
                                ...
                                if not _tpl_carrier_id or _tpl_carrier_id == 'UNKNOWN':
                                    try:
                                        _auto_tpl = self._auto_match_template_by_carrier(_carrier_id)
                                        if _auto_tpl:
                                            _tpl_carrier_id = _carrier_id
                                            _bag_weight = int(_auto_tpl.get('bag_weight_kg', _bag_weight))
                                            _hint_packing = str(_auto_tpl.get('gemini_hint_packing', '') or '') or _hint_packing
                                            _hint_invoice = str(_auto_tpl.get('gemini_hint_invoice', '') or '') or _hint_invoice
                                            _hint_bl = str(_auto_tpl.get('gemini_hint_bl', '') or '') or _hint_bl
                                            _bl_format = str(_auto_tpl.get('bl_format', '') or '') or _bl_format
