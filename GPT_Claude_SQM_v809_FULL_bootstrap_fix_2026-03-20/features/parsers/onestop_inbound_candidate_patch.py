...
def parse_bl_with_candidate(
    ...
    if not use_multi:
        ...
        try:
            return parser.parse_bl(file_path, gemini_hint=hint_bl, bl_format=bl_format)
        except TypeError:
    ...
    try:
        ...
        try:
            bl_result = parser.parse_bl(file_path, gemini_hint=final_hint)
            return bl_result
