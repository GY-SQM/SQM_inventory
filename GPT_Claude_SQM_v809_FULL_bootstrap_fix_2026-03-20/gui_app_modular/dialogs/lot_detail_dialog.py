...
class LotDetailDialogMixin:
    ...
    def _show_lot_detail_popup(self, lot_no: str, source_tab: str = None) -> None:
        ...
        fg = ThemeColors.get('text_primary', dark_mode)
        header_bg = ThemeColors.get('statusbar_bg', dark_mode) if dark_mode else ThemeColors.get('text_primary', dark_mode)
        card_bg = ThemeColors.get('bg_secondary', dark_mode)
        ...
        _label_fg = fg if dark_mode else ThemeColors.get('text_secondary')
        ...
        weight_items = [
            ...
            ('📤 출고', f'{out_w:,.0f} kg', ThemeColors.get('statusbar_icon_warn', dark_mode)),
        ...
        for label, value, color in weight_items:
            ...
            tk.Label(f, text=label, font=FONT_LABEL, bg=card_bg, fg=_label_fg).pack(anchor='w')
            tk.Label(f, text=value, font=FONT_WEIGHT, bg=card_bg, fg=fg if dark_mode else color).pack(anchor='w')
        ...
        tb_tree.tag_configure('available', background=ThemeColors.get('available', dark_mode), foreground=fg)
        tb_tree.tag_configure('picked', background=ThemeColors.get('picked', dark_mode), foreground=fg)
        tb_tree.tag_configure('shipped', background=ThemeColors.get('shipped', dark_mode), foreground=fg)
        tb_tree.tag_configure('depleted', background=ThemeColors.get('bg_secondary', dark_mode), foreground=ThemeColors.get('text_muted', dark_mode))
        tb_tree.tag_configure('sample', background=ThemeColors.get('available', dark_mode), foreground=fg)
        ...
        mv_tree.tag_configure('inbound', background=ThemeColors.get('available', dark_mode), foreground=fg)
        mv_tree.tag_configure('outbound', background=ThemeColors.get('picked', dark_mode), foreground=fg)
        mv_tree.tag_configure('return_mv', background=ThemeColors.get('available', dark_mode), foreground=fg)
