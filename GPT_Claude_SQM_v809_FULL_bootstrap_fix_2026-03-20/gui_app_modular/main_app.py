...
from tkinter.constants import BOTH, YES, LEFT, RIGHT, TOP, BOTTOM, X, Y
...
class SQMInventoryApp:
    ...
    def __init__(self, root=None, db_path: Optional[str] = None):
        ...
        # v7.9.3 [STARTUP-CHECK]: 시작 시 버전 + DB 핵심 상태 자동 확인 로그
    ...
    def _init_state(self) -> None:
        ...
        try:
            ...
            set_global_theme(self.current_theme)  # v9.0
        except Exception:
    ...
    def _setup_ui(self) -> None:
        ...
        self._sidebar_frame = tk.Frame(self.main_frame, width=100, bg=tc('bg_secondary'))
        ...
        self.tab_scan = ttk.Frame(self.notebook)  # v7.4.0: 스캔 탭
        ...
        self.notebook.add(self.tab_sold, text="  ✅ 출고완료(OUTBOUND)  ")
        ...
        self.notebook.add(self.tab_scan, text="  📷 스캔  ")
        ...
        if hasattr(self, '_sidebar_frame'):
            ...
            self._tab_index_map = {
                ...
                'cargo_overview': 4, 'dashboard': 5, 'log': 6
            }
        ...
        def _on_notebook_tab_changed(event):
            try:
                ...
                idx_to_key = {0: 'inventory', 1: 'allocation', 2: 'picked', 3: 'sold', 4: 'cargo_overview', 5: 'dashboard', 6: 'log', 7: 'scan'}
