...
class TonbagTabMixin:
    ...
    def _setup_tonbag_tab(self) -> None:
        ...
        self._tonbag_columns = [
            ...
            ('location',           'LOCATION',      110, 'center', True),  # 톤백 위치(필수 표시)
        ...
        dark_mode_tb = is_dark()
        _tb_bg = ThemeColors.get('bg_card', dark_mode_tb)
        _tb_fg = ThemeColors.get('text_primary', dark_mode_tb)
        _tb_field = _tb_bg
        _tb_hd_bg = ThemeColors.get('bg_secondary', dark_mode_tb)
        _tb_hd_fg = ThemeColors.get('text_primary', dark_mode_tb)
        ...
        _style.map('Tb.Treeview',
                   background=[('selected', ThemeColors.get('tree_select_bg', dark_mode_tb))],
                   foreground=[
                       ('selected', ThemeColors.get('tree_select_fg', dark_mode_tb)),
                       ('!selected', _tb_fg),
                   ])
        ...
        # ═══════════════════════════════════════════════════════════════
        _tb_bg = ThemeColors.get('bg_secondary', dark_mode_tb)
        ThemeColors.get('bg_card', dark_mode_tb)
        ThemeColors.get('border', dark_mode_tb)
        ThemeColors.get('text_primary', dark_mode_tb)
        ...
        # self._tb_footer = FooterTotalBar(self.tab_tonbag, is_dark=dark_mode_tb)
    ...
    def _setup_tonbag_lot_detail_panel(self) -> None:
        ...
        sb = tk.Scrollbar(detail_container, orient=VERTICAL, command=self._tb_lot_detail_tree.yview)
        sb_x = tk.Scrollbar(detail_container, orient='horizontal', command=self._tb_lot_detail_tree.xview)
