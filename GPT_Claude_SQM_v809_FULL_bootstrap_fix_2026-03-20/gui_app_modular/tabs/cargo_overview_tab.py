    ...
    def _setup_cargo_overview_tab(self) -> None:
        ...
        try:
            ...
            make_tab_header(frame, "📋 총괄 재고 리스트",
                            status_color='#8b5cf6', is_dark=dark_mode)
        except Exception:
        ...
        _tv_bg = ThemeColors.get('bg_card', dark_mode)
        _tv_fg = ThemeColors.get('text_primary', dark_mode)
        _tv_head_bg = ThemeColors.get('bg_secondary', dark_mode)
        _tv_head_fg = ThemeColors.get('text_primary', dark_mode)
        ...
        _style.map('Cargo.Treeview',
                   background=[('selected', ThemeColors.get('tree_select_bg', dark_mode))],
                   foreground=[
                       ('selected', ThemeColors.get('tree_select_fg', dark_mode)),
                       ('!selected', _tv_fg),
                   ])
        ...
        apply_striped_rows(self.tree_cargo_overview, dark_mode)
        ThemeColors.configure_tags(self.tree_cargo_overview, dark_mode)
