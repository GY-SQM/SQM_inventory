...
class InboundMixin(InventoryBaseMixin):
    ...
    # ══════════════════════════════════════════════════════════════════════
    # v8.7.0: process_inbound 분해 — 서브메서드 3개
    # ══════════════════════════════════════════════════════════════════════

    @staticmethod
    def _inb_normalize_packing(packing_data) -> dict:
        """v8.7.0: packing_data → 표준 dict 정규화 (process_inbound 분해 1/3)"""
    ...
    def _inb_validate_lot(packing: dict, result: dict) -> bool:
        """v8.7.0: LOT/무게/BL 기본 유효성 검증 (process_inbound 분해 2/3).
    ...
    def _inb_record_audit(db, lot_no: str, batch_id: str,
        ...
        """v8.7.0: 입고 audit_log 기록 (process_inbound 분해 3/3)."""
