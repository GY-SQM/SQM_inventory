...
# DEPRECATED: duplicate of validate_lot_no() defined above — v8.6.3 removed
    # REMOVED v8.7.0: duplicate validate_lot_no() — kept first definition
...
# DEPRECATED: duplicate of validate_weight() defined above — v8.6.3 removed
    ...
    # REMOVED v8.7.0: duplicate validate_weight() — kept first definition
    ...
    def check_data_integrity(self) -> ValidationResult:
        ...
        # v8.7.0-fix: SAMPLE 제외 — 샘플 톤백(1kg)은 inventory.current_weight에 미포함.
        try:
            ...
            if cross_check:
                for row in cross_check[:5]:
                    ...
                    if ton_w < 100 and inv_w > 1000:
                        ...
                        # ─────────────────────────────────────────────────────
                        # 과거(v8.7.0): inventory.current_weight=5001, 본품톤백합=5000
                            ...
                            try:
                                self.db.execute(
                                    ...
                                    (
                                        ...
                                        f'"rule":"v8.7.0_auto_correct","action":"HELD_NOT_APPLIED"}}',
