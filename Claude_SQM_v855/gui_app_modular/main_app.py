...
class SQMInventoryApp:
    ...
    def _setup_ui(self) -> None:
        ...
        # v7.0: 시작 시 첫 탭 (tab_inventory = AVAILABLE) — v8.1.6: 위젯 참조
        try:
    ...
    def _setup_ui_helper(self) -> None:
        ...
        try:
            ...
            # v8.4.1 [BUG-A]: 앱 시작 시 테마/스크롤바/Footer 레이스컨디션 해결
            # 모든 탭을 1회 순회하여 위젯 렌더링 강제 → 원래 탭 복귀 → 테마 재적용
            self.root.after(300, self._force_initial_theme_refresh)
